...
export const mainPanelList = [
  ...
  },
  {
    ...
    label: "کتاب",
    href: `/${modules.MAIN}/book`,
  },
  {
    key: "2",
    icon: <IconifyComp icon="star" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "نظرسنجی",
    href: `/${modules.MAIN}/survey`,
  },
  {
    key: "3",
    icon: <IconifyComp icon="group" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "دعوت به همکاری",
    href: `/${modules.MAIN}/invite-to-work`,
  },
  {
    key: "4",
    icon: <IconifyComp icon="setting" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "تنظیمات",
    href: `/${modules.MAIN}/setting`,
  },
];
export const accidentsList = [
  {
    key: "1",
    icon: <IconifyComp icon="newsPaper" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "حوادث",
    href: `/${modules.ACCIDENT}/`,
  },
  {
    key: "4",
    icon: <IconifyComp icon="setting" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "تنظیمات",
    href: `/${modules.ACCIDENT}/setting`,
  },
];
export const examList = [
  {
    key: "1",
    icon: <IconifyComp icon="layers2" size="xl" className="!min-w-[25px] !min-h-[25px] !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "مقطع",
    href: `/${modules.EXAMS}/`,
  },
  {
    key: "2",
    icon: <IconifyComp icon="checkList" size="xl" className="!min-w-6 !min-h-6 !mx-aut1o !p-0 menuIcon-iconify" />,
    label: "آزمون",
    children: [
      {
        key: "3",
        icon: <IconifyComp icon="addDocument" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
        label: "ایجاد آزمون",
        href: `/${modules.EXAMS}/create-exam`,
      },
      {
        key: "4",
        icon: <IconifyComp icon="lightbulb" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
        label: "راهنمای آزمون",
        href: `/${modules.EXAMS}/guideline`,
      },
      {
        key: "5",
        icon: <IconifyComp icon="playList" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
        label: "عملیات آزمون",
        href: `/${modules.EXAMS}/operation`,
      },
      {
        key: "6",
        icon: <IconifyComp icon="circleDanger" size="xl" className="!min-w-5 !min-h-5 !mx-aut1o !p-0 menuIcon-iconify" />,
        label: "مواد آزمون",
        href: `/${modules.EXAMS}/testItems`,
      },
    ]
  },
  // {
