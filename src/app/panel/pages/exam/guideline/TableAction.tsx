...
// form
import DegreeForm from "./forms/GuidlineForm";
// api
...
const TableAction: React.FC<{
  ...
  const handleDeleteDegree = () => {
    const loadingToast = toast.loading("در حال حذف راهنما ");

    apiDeleteExamItems(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success(`راهنمای ${rowData.title} با موفقیت حذف شد`);
      })
      .catch(() => {
        toast.dismiss(loadingToast);
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      ...
      {/* delete */}
      <Tooltip title="حذف راهنما">
        <Popconfirm
          title="حذف راهنما"
          description="آیا از حذف راهنما اطمینان دارید"
          okText="بله"
          cancelText="خیر"
