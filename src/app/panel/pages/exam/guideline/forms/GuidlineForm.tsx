...
const GuidlineForm = ({ hideModal, handleRefreshTable, rowData }) => {

  const fakeList = [
    { label: "ثبت نام", value: "ثبت نام" },
    { label: "پاسخ نامه", value: "پاسخ نامه" },
    { label: "شرکت در جلسه", value: "شرکت در جلسه" },
    { label: "دریافت کارت", value: "دریافت کارت" },
    { label: "اعلام نتایج", value: "اعلام نتایج" },
