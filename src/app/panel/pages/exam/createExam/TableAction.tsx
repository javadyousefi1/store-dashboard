...
// form
import DegreeForm from "./forms/ExamForm";
// api
import { apiDeleteExam } from "@/api/exam";
// interface
...
const TableAction: React.FC<{
  ...
  const handleDeleteDegree = () => {
    const loadingToast = toast.loading("در حال حذف آزمون ");

    apiDeleteExam(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success(`آزمون ${rowData.title} با موفقیت حذف شد`);
      })
      .catch(() => {
        toast.dismiss(loadingToast);
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      ...
      {/* delete */}
      <Tooltip title="حذف آزمون">
        <Popconfirm
          title="حذف آزمون"
          description="آیا از حذف آزمون اطمینان دارید"
          okText="بله"
          cancelText="خیر"
