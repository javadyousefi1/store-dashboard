...
// form
import DegreeForm from "./forms/OperationForm";
// api
...
const TableAction: React.FC<{
  ...
  const handleDeleteDegree = () => {
    const loadingToast = toast.loading("در حال حذف عملیات ");

    apiDeleteExamItems(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success(`عملیات ${rowData.title} با موفقیت حذف شد`);
      })
      .catch(() => {
        toast.dismiss(loadingToast);
        toast.error("حذف عملیات با خطا مواجه شد");
      });
  };
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      ...
      <Tooltip title="حذف عملیات">
        <Popconfirm
          title="حذف عملیات"
          description="آیا از حذف عملیات اطمینان دارید"
          okText="بله"
          cancelText="خیر"
