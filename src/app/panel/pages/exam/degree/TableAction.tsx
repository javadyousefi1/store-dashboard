...
// api
import { apiDeleteDegree } from "@/api/degree";
// interface
...
const TableAction: React.FC<{
  ...
  const handleDeleteDegree = () => {
    const loadingToast = toast.loading("در حال حذف مقطع ");

    apiDeleteDegree(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success(`مقطع ${rowData.title} با موفقیت حذف شد`);
      })
      .catch(() => {
        toast.dismiss(loadingToast);
        toast.error("حذف مقطع با خطا مواجه شد");
      });
  };
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      ...
      {/* delete */}
      <Tooltip title="حذف مقطع">
        <Popconfirm
          title="حذف مقطع"
          description="آیا از حذف مقطع اطمینان دارید؟"
          okText="بله"
          cancelText="خیر"
