...
// form
import DegreeForm from "./forms/TestItemsForm";
// api
import { apiDeleteExamItems } from "@/api/examItems";
// interface
...
const TableAction: React.FC<{
  ...
  const handleDeleteDegree = () => {
    const loadingToast = toast.loading("در حال حذف مواد آزمون ");
    apiDeleteExamItems(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success(`مواد آزمون ${rowData.title} با موفقیت حذف شد`);
      })
      .catch(() => {
        toast.dismiss(loadingToast);
        toast.error("حذف مواد آزمون با خطا مواجه شد");
      });
  };
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      {/* edit */}
      <Tooltip title="ویرایش مواد آزمون">
      ...
      {/* delete */}
      <Tooltip title="حذف مواد آزمون">
        <Popconfirm
          title="حذف مواد آزمون"
          description="آیا از حذف مواد آزمون اطمینان دارید"
          okText="بله"
          cancelText="خیر"
