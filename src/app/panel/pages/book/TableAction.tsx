...
const TableAction: React.FC<{
  ...
  const handleDeleteNews = () => {
    const loadingToast = toast.loading("در حال حذف کتاب ");
    ...
    deleteBook(rowData.id)
      ...
      .catch(() => {
        toast.dismiss(loadingToast);
        toast.error("حذف کتاب با خطا مواجه شد");
      });
  };
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      ...
      {/* delete */}
      <Tooltip title="حذف کتاب">
        <Popconfirm
          title="حذف کتاب"
          description="آیا از حذف کتاب اطمینان دارید"
          okText="بله"
          cancelText="خیر"
