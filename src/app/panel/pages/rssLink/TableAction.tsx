...
// api
import { deleteRssLink } from "@/api/rssLink";
// interface
...
const TableAction: React.FC<{
  ...
  const handleDeleteNews = () => {
    const loadingToast = toast.loading("در حال حذف لینک RSS ");

    deleteRssLink(rowData.id)
      .then(() => {
        handleRefreshTable();
        toast.dismiss(loadingToast);
        toast.success("لینک RSS با موفقیت حذف شد");
      })
      .catch(() => {
        toast.dismiss(loadingToast);
        toast.error("حذف لینک RSS با موفقیت خطا مواجه شد");
      });
  };
  ...
  return (
    <div className="flex items-center justify-center gap-x-4">
      {/* delete */}
      <Tooltip title="حذف لینک RSS">
        <Popconfirm
          title="حذف لینک RSS"
          description="آیا از حذف لینک RSS اطمینان دارید"
          okText="بله"
          cancelText="خیر"
